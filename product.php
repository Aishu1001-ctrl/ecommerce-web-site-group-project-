...
// Fetching product details based on ecat_id
...
// Incrementing product view count
...
if (isset($_POST['form_review'])) {
    ...
    $existing_review_count = $statement->rowCount();
    
    if ($existing_review_count) {
        $error_message = LANG_VALUE_68; // Review already exists error message
    } else {
        ...
        $success_message = LANG_VALUE_163; // Success message after review submission
    }
